...
def run_training(cfg, created_datasets, clearml_task):
    ...
    dataloader = setup_concat_dataloader(cfg=cfg,
    ...
    if val_epoch > 0:
        val_dataloaders = setup_dataloaders_per_dataset(cfg=cfg,
                                                        created_datasets=created_datasets,
                                                        split='val')
    ...
    for epoch in range(cfg.epochs):
        ...
        if val_epoch > 0 and epoch % val_epoch == 0:
            ...
            assert val_dataloaders is not None, "No validation dataloaders available, set val_epoch == 0 to disable validation or provide validation dataloaders"
